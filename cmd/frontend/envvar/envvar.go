...
var exportRawTelemetry, _ = strconv.ParseBool(env.Get("EXPORT_RAW_TELEMETRY", "false", "Send all raw telemetry to Sourcegraph instead of locally in a database."))
...
func ExportRawTelemetry() bool {
	return exportRawTelemetry
}
