...
const typeIconMap: Record<CompletionType, string> = {
    ...
    MEMBER: mdiTextBox,
    MENU: mdiShape,
    MESSAGE: mdiCodeString,
    METHOD: mdiCubeOutline,
    METHODSPEC: mdiCubeOutline,
    MINORMODE: mdiShape,
    MISC: mdiShape,
    MIXIN: mdiShape,
    MLCONN: mdiShape,
    ...
    SUBPROGRAM: mdiFunction,
    SUBPROGSPEC: mdiPackage,
    SUBROUTINE: mdiFunction,
