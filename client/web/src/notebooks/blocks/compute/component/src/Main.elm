...
placeholderQuery =
    "repo:github\\.com/sourcegraph/sourcegraph$ content:output((are you ready?) -> $1,$author) type:commit after:\"1 month ago\" count:all"
...
emptyGraph =
    GF.new
        { graph = Graph.fromNodesAndEdges [] [] |> Graph.Layout.circular { center = ( 300, 300 ), radius = 250 }
        , bags = Dict.empty
